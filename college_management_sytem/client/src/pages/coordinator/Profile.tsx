...
import { getCoordinatorProfile } from "../../services/coordinatorService";
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 mt-1">
          Academic administrator identity and assigned department responsibilities
        </p>
      </div>

      <Card className="relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-gray-100 dark:border-slate-800">
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-tr from-purple-600 to-indigo-500 text-white flex items-center justify-center text-3xl font-bold shadow-lg">
            {profile?.name ? profile.name.charAt(0).toUpperCase() : "C"}
          </div>
          <div className="text-center sm:text-left">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">{profile?.name}</h2>
            <p className="text-xs text-purple-600 dark:text-purple-400 font-semibold mt-0.5">Academic Coordinator</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 text-xs">
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-slate-950/60 border border-gray-100 dark:border-slate-800 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="font-mono font-bold text-gray-900 dark:text-white">{profile?.employeeId || "EMP-CORD-005"}</span>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-slate-950/60 border border-gray-100 dark:border-slate-800 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="font-semibold text-gray-900 dark:text-white">{profile?.phone || "+1 555-0177"}</span>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-gray-50 dark:bg-slate-950/60 border border-gray-100 dark:border-slate-800 flex items-center gap-3">
            ...
            <div>
              <span className="text-gray-400 block text-[10px]">Managed Department</span>
              <span className="font-semibold text-gray-900 dark:text-white">{profile?.department || "Computer Science & Engineering"}</span>
            </div>
          </div>
        </div>
      </Card>
